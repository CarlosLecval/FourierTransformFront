...
$(document).ready(function () {
    ...
    imagen.src = 'https://fourierbucket.s3.us-west-2.amazonaws.com/bg_image_g_' + imageName + '.png';
    var clic = false;
    var xCoord, yCoord = "";
    var canvas = document.getElementById("gameCanvasB");
    ...
    $("#gameCanvasB").mousedown(function (canvas) {
        clic = true;
        cntx.save();
    ...
    $("#gameCanvasB").mousemove(function (canvas) {
        if (clic == true) {
            cntx.beginPath();
